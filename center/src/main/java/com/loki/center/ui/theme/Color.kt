...
val blue1 = Color(0xFFADD8E6).convert(ColorSpaces.CieXyz) // Light Blue
val blue2 = Color(0xFF87CEEB).convert(ColorSpaces.CieXyz) // Sky Blue
val blue3 = Color(0xFF4682B4).convert(ColorSpaces.CieXyz) // Steel Blue
val blue4 = Color(0xFF1E90FF).convert(ColorSpaces.CieXyz) // Dodger Blue
val blue5 = Color(0xFF0000CD).convert(ColorSpaces.CieXyz) // Medium Blue
val blue6 = Color(0xFF00008B).convert(ColorSpaces.CieXyz) // Dark Blue

val pink1 = Color(0xFFFFC1CC).convert(ColorSpaces.CieXyz) // Light Pink
val pink2 = Color(0xFFFFB6C1).convert(ColorSpaces.CieXyz) // Pale Pink
val pink3 = Color(0xFFFF69B4).convert(ColorSpaces.CieXyz) // Hot Pink
val pink4 = Color(0xFFDB7093).convert(ColorSpaces.CieXyz) // Medium Pink
val pink5 = Color(0xFFC71585).convert(ColorSpaces.CieXyz) // Deep Pink
val pink6 = Color(0xFFB03060).convert(ColorSpaces.CieXyz) // Dark Pink